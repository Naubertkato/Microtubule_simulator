#ifndef _CGLASS_TEMPERATURE_POTENTIAL_H_
#define _CGLASS_TEMPERATURE_POTENTIAL_H_

#include "auxiliary.hpp"
#include "interaction.hpp"
#include "potential_base.hpp"

class TemperaturePotential : public PotentialBase {
protected:
  double eps_, sigma_, c12_, c6_, shift_, temperature_;
...
public:
  ...
  void CalcPotential(Interaction &ix) {
    ...
    double ffac = -(12.0 * c12_ * r6 - temperature_*6.0 * c6_) * r6 * rinv;
